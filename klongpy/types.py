...
class KGCall(KGFn):
    __slots__ = ('_cached_body', '_cached_body_arity', '_cached_body_type', '_cached_version', '_cached_cond_is_dyad_op', '_cached_true_is_sym', '_cached_false_is_dyad_op', '_nargs', '_f_args', '_arg0_is_dyad_op')
